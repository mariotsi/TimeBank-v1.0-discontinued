...
public class Annuncio {
    ...
    Annuncio(int id_annuncio, String data_inserimento, String data_annuncio, boolean richiesto, String descrizione, String richiedente, String creatore, int id_categoria, String nome_cat, int codiceErrore, String provincia, String nomeComune) {
